...
import { EntityArrayResponseType, ClusterService } from '../service/cluster.service';
...
export class ClusterComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICluster): number => this.clusterService.getClusterIdentifier(item);
