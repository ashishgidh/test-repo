...
class ClientResourceIT {
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.clientId(UPDATED_CLIENT_ID).name(UPDATED_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE).company(UPDATED_COMPANY);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.clientId(UPDATED_CLIENT_ID).name(UPDATED_NAME);
